INSERT INTO Books
(title, author, genre, published_year, isbn, price, rating, stock_count, publisher, number_of_pages)
 VALUES 
 ('A Journey to the Center', 'Jules Verne', 'Adventure', 1864, 1234567890123, 12.99, 4.5, 10, 'Verne Publishing', 350),
 ('War and Peace', 'Leo Tolstoy', 'Historical', 1869, 134567890124, 14.99, 4.8, 5, 'Tolstoy Prints', 1200),
